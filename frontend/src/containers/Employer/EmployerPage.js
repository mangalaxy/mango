...
import TalentFullProfile from '../../components/Employer/TalentFullProfile/TalentFullProfile';
  ...
  render(): React.ReactElement<any> | string | number | {} | React.ReactNodeArray | React.ReactPortal | boolean | null | undefined {
    return (
        <div className="employer-bg">
          ...
          <Route path={routes.TALENT_FULL_PROFILE} component={TalentFullProfile}/>
        </div>  
    );
  }
}
